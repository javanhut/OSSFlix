...
export default function Stats() {
  ...
  return (
    <div style={{ padding: "2rem 4%", minHeight: "100vh", maxWidth: "1000px", margin: "0 auto" }}>
      ...
      {/* Library Overview */}
      <h3 style={{ fontSize: "1rem", fontWeight: 600, color: "var(--oss-text-muted)", marginBottom: "12px", textTransform: "uppercase", letterSpacing: "0.5px", fontSize: "0.78rem" }}>
        Library
      </h3>
      <div style={{
        display: "grid",
      ...
      {/* Watch Activity */}
      <h3 style={{ fontSize: "0.78rem", fontWeight: 600, color: "var(--oss-text-muted)", marginBottom: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
        Your Activity
      </h3>
      <div style={{
        display: "grid",
        ...
        <div style={cardStyle}>
          <div style={{ fontSize: "2rem", fontWeight: 800, color: hasWatchData ? "var(--oss-accent)" : "var(--oss-text-muted)", lineHeight: 1.2 }}>
            {stats.totalHours}
          </div>
          <div style={{ fontSize: "0.78rem", color: "var(--oss-text-muted)", marginTop: "4px" }}>
            Hours Watched
        ...
        <div style={cardStyle}>
          <div style={{ fontSize: "2rem", fontWeight: 800, color: hasWatchData ? "var(--oss-green)" : "var(--oss-text-muted)", lineHeight: 1.2 }}>
        ...
        <div style={cardStyle}>
          <div style={{ fontSize: "2rem", fontWeight: 800, color: hasWatchData ? "var(--oss-text)" : "var(--oss-text-muted)", lineHeight: 1.2 }}>
            {stats.titlesWatched}
          </div>
          <div style={{ fontSize: "0.78rem", color: "var(--oss-text-muted)", marginTop: "4px" }}>
            Started
        ...
        <div style={cardStyle}>
          <div style={{ fontSize: "2rem", fontWeight: 800, color: stats.watchStreak > 0 ? "#f59e0b" : "var(--oss-text-muted)", lineHeight: 1.2 }}>
            {stats.watchStreak}
          </div>
          <div style={{ fontSize: "0.78rem", color: "var(--oss-text-muted)", marginTop: "4px" }}>
            Day Streak
